    ...
    return {
        loadDefaults: function () {
            var properties = {
                ...
                mongodbDatabase: process.env.OPENSHIFT_MONGODB_DB_DATABASE || defaultDatabaseConfiguration.mongodbDatabase
            };
            properties.mongodbUrl = process.env.OPENSHIFT_MONGODB_DB_URL || createMongoDbUrl(properties);
            return properties;
        },
